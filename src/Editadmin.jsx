...
const Editadmin = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            let admin = await axios.put(
                `${env.api}/admin/${params.id}`, values,{
                    headers : {
    ...
    let loadAdmin = async () => {
        try {
           ...
           formik.setValues ({
            ...
            position: admin.data.position,
            office: admin.data.office,
            age: admin.data.age,
            startdate: admin.data.startdate,
            salarey: admin.data.salarey
           })
        }catch (error){
